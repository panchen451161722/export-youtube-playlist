...
export function FAQ() {
  ...
  return (
    <section
      id="faq"
      className="bg-muted/35 scroll-mt-24 border-y px-4 py-24 sm:py-28"
    >
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
        ...
        <div className="border-border/70 bg-background overflow-hidden rounded-3xl border px-5 shadow-sm sm:px-7">
              ...
              <div key={index} className="border-b last:border-b-0">
                <h3>
                  <button
                    ...
                    className="focus-visible:ring-ring/50 flex min-h-16 w-full items-center justify-between gap-5 rounded-lg py-5 text-left text-base font-semibold outline-none focus-visible:ring-3 sm:text-lg"
                  >
                    {question()}
                    <Plus
                      aria-hidden="true"
